...
func (server) VerifyUpgrade(_ context.Context, req *pb.VerifyUpgradeRequest) (*emptypb.Empty, error) {
	lc := NewLightclient(req.State)
	return nil, lc.VerifyUpgrade(req.NewClient, *req.UpgradeHeight, req.ProofUpgrade)
}
...
func (server) VerifyClientState(_ context.Context, req *pb.VerifyClientStateRequest) (*emptypb.Empty, error) {
	lc := NewLightclient(req.State)
	return nil, lc.VerifyClientState(*req.Height, req.Prefix, req.CounterpartyClientIdentifier, req.Proof, req.ClientState)
}

func (server) VerifyClientConsensusState(_ context.Context, req *pb.VerifyClientConsensusStateRequest) (*emptypb.Empty, error) {
	lc := NewLightclient(req.State)
	return nil, lc.VerifyClientConsensusState(*req.Height, req.CounterpartyClientIdentifier, *req.ConsensusHeight, req.Prefix, req.Proof, req.ConsensusState)
}

func (server) VerifyConnectionState(_ context.Context, req *pb.VerifyConnectionStateRequest) (*emptypb.Empty, error) {
	lc := NewLightclient(req.State)
	return nil, lc.VerifyConnectionState(*req.Height, req.Prefix, req.Proof, req.ConnectionId, *req.ConnectionEnd)
}

func (server) VerifyChannelState(_ context.Context, req *pb.VerifyChannelStateRequest) (*emptypb.Empty, error) {
	lc := NewLightclient(req.State)
	return nil, lc.VerifyChannelState(*req.Height, req.Prefix, req.Proof, req.PortId, req.ChannelId, *req.Channel)
}

func (server) VerifyPacketCommitment(_ context.Context, req *pb.VerifyPacketCommitmentRequest) (*emptypb.Empty, error) {
	lc := NewLightclient(req.State)
	return nil, lc.VerifyPacketCommitment(*req.Height, req.Prefix, req.Proof, req.PortId, req.ChannelId, req.Sequence, req.CommitmentBytes)
}

func (server) VerifyPacketAcknowledgement(_ context.Context, req *pb.VerifyPacketAcknowledgementRequest) (*emptypb.Empty, error) {
	lc := NewLightclient(req.State)
	return nil, lc.VerifyPacketAcknowledgement(*req.Height, req.Prefix, req.Proof, req.PortId, req.ChannelId, req.Sequence, req.Acknowledgement)
}

func (server) VerifyPacketReceiptAbsence(_ context.Context, req *pb.VerifyPacketReceiptAbsenceRequest) (*emptypb.Empty, error) {
	lc := NewLightclient(req.State)
	return nil, lc.VerifyPacketReceiptAbsence(*req.Height, req.Prefix, req.Proof, req.PortId, req.ChannelId, req.Sequence)
}

func (server) VerifyNextSequenceRecv(_ context.Context, req *pb.VerifyNextSequenceRecvRequest) (*emptypb.Empty, error) {
	lc := NewLightclient(req.State)
	return nil, lc.VerifyNextSequenceRecv(*req.Height, req.Prefix, req.Proof, req.PortId, req.ChannelId, req.NextSequenceRecv)
}
