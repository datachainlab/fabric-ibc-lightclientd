...
type State struct {
	...
	ConsensusStates map[string]*types.ConsensusState `protobuf:"bytes,2,rep,name=consensus_states,json=consensusStates,proto3" json:"consensus_states,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *State) GetConsensusStates() map[string]*types.ConsensusState {
	if m != nil {
...
func init() {
	...
	proto.RegisterMapType((map[string]*types.ConsensusState)(nil), "ibc.lightclientd.fabric.v1.State.ConsensusStatesEntry")
...
var fileDescriptor_6967e85c342bf417 = []byte{
	...
	,
}
...
func (m *State) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ConsensusStates) > 0 {
		for k := range m.ConsensusStates {
			...
			i -= len(k)
			copy(dAtA[i:], k)
			i = encodeVarintFabric(dAtA, i, uint64(len(k)))
			i--
			dAtA[i] = 0xa
...
func (m *State) Size() (n int) {
	...
	if len(m.ConsensusStates) > 0 {
		for k, v := range m.ConsensusStates {
			...
			mapEntrySize := 1 + len(k) + sovFabric(uint64(len(k))) + l
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.ConsensusStates == nil {
				m.ConsensusStates = make(map[string]*types.ConsensusState)
			}
			var mapkey string
